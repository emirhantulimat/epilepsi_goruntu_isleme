...
df = pd.read_csv(r"C:\Users\Amrtu\Desktop\Staj 2\epilepsi_goruntu_isleme\dataframe.csv")
...
clf = RandomizedSearchCV(svm.SVC() , parameters)

clf.best_estimator_

clf = svm.SVC(kernel='poly', gamma=0.01, C=10.0)
